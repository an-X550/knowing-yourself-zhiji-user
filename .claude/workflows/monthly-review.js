...
var distribution = {
  ...
  trigger: 'distribute output.monthly_report ' + reportPath,
...
return { month: month, perspectives: successful.length, mode: mode, synthesis: 'complete', reportPath: reportPath, distribution: distribution }
